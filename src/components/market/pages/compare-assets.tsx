...
/** Compare content — shared by the console page (/compare) and the public homepage page (/markets/compare). */
export function CompareAssetsContent() {
              ...
              <tr key={k} className="border-b border-border/60 last:border-0">
                ...
                <td
                  className={cn(
                    ...
                    k.includes("change") && (parseFloat(l) >= 0 ? "text-up" : "text-down"),
                  )}
                >
                  {l}
                </td>
                <td
                  className={cn(
                    "num px-4 py-3 text-right",
                    k.includes("change") && (parseFloat(r) >= 0 ? "text-up" : "text-down"),
                  )}
                >
                  {r}
                </td>
